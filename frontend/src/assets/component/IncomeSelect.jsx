...
const IncomeSelect = ({ value, onChange }) => {

    const [isOpen, setIsOpen] = useState(false);

    const options = [
    { id: 1, label: "Salary/Wages", desc: "Monthly/Weekly or Daily Salary" },
    { id: 2, label: "Freelance/Side hustle", desc: "Freelancing or Online gig Like Fiver Upwork" },
    { id: 3, label: "Business Income", desc: "Service Based Incomes" },
    { id: 4, label: "Investment", desc: "Profitable investments" },
    { id: 5, label: "Others", desc: "Other incomes like gifts, Rewards Allowances" },
  ];
