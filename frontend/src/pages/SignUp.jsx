  ...
  return (
    <main>
          <div className='items-center justify-center'>
              ...
              <p className='text-center  text-white text-white pt-2 text-sm'>Create an Account to track your wealth</p>
              
              <div className='flex justify-center mt-5'>
                <div className='w-[430px] bg-dark-100  rounded-md p-8 shadow-lg blackdrop-filter blackdrop-blur-sm bg-opacity-30 relative  '>
                <div className=''>
